...
class plgSystemNRFramework extends CMSPlugin
{
	...
	public function onInstallerBeforePackageDownload(&$url, &$headers)
	{
		...
		$this->app->enqueueMessage('To be able to update the Pro version of this extension via the Joomla updater, you will need enter your Download Key in the settings of the <a href="' . JURI::base() . 'index.php?option=com_plugins&view=plugins&filter_search=tassos">Tassos Framework System Plugin</a>');
		return true;
	}
