...
class JFormFieldNRResponsiveControl extends JFormFieldText
{
    ...
    private function getSubtypeFieldsData()
    {
        ...
        $default = $control_default && isset($control_default[$device]) ? $control_default[$device] : null;
    ...
    {
        JHtml::stylesheet('plg_system_nrframework/controls/responsive_control.css', ['relative' => true, 'version' => 'auto']);
        JHtml::script('plg_system_nrframework/controls/responsive_control.js', ['relative' => true, 'version' => 'auto']);
