...
class JFormFieldTFUnitControl extends JFormFieldText
{
    ...
    public function getInput()
    {
        ...
        $layout = new JLayoutFile('unit', JPATH_PLUGINS . '/system/nrframework/layouts/controls');
    ...
    private function assets()
    {
        ...
        JHtml::stylesheet('plg_system_nrframework/controls/unit.css', ['relative' => true, 'version' => 'auto']);
    }
}