...
abstract class JFormFieldAjaxify extends JFormFieldList
{
    ...
    {   
        ...
        return '<div class="tf-ajaxify-wrapper" data-single-value="' . var_export($isSingle, true) . '" data-search-placeholder="' . JText::_($searchPlaceholder) . '" data-placeholder="' . htmlspecialchars(JText::_($this->placeholder)) . '" data-ajax-endpoint="' . $this->getAjaxEndpoint() . '">' . parent::getInput() . '</div>';
    }
