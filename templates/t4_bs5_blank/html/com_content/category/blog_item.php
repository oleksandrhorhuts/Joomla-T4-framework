...
?>
<div class="article-items" id="article<?php echo $this->item->id ?>">
    <?php if ($canEdit) : ?>
    ...
    <?php  
        ...
        ?>
            <div class="article-category-image">
                <a class="item-image" href="<?php echo $this->item->link; ?>" title="<?php echo $this->item->title; ?>">
                    <img src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo $this->item->title; ?>" />
                </a>
            </div>
    <?php } ?>
