...
<tr class="category<?php echo $this->escape($category->class_sfx) . $txt; ?>">
  <?php if ($topic->unread) : ?>
    <th scope="row" class="center d-none d-md-table-cell topic-item-unread">
  ...
  <td class="d-none d-md-table-cell py-2 px-3">
    <div class="views p-3 d-flex flex-column text-center">
      <div class="views">
        <span class="viewsnum float-none"><?php echo $this->formatLargeNumber($topic->hits); ?></span>
    ...
    <div class="d-flex align-items-center">
      <?php if ($config->avatarOnCategory) : ?>
        ...
        <?php else : ?>
          <div class="col-md-12">
          <?php endif; ?>
          <span class="d-block mb-1 lastpostlink"><?php echo $this->getTopicLink($this->topic, 'last', Text::_('COM_KUNENA_GEN_LAST_POST'), null, KunenaTemplate::getInstance()->tooltips(), $category, false, true); ?>
